...
void CampoVectorial::ajustarRangosXY()
{
    xmin = -5;   xmax = 5; //cuando modifico estos parámetros cambio lo que se proyecta
    ymin = -5;   ymax = 5; //en el tamaño de la ventana(no cambio la cantidad de pixeles)
