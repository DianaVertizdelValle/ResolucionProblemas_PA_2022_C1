...
Empleado::Empleado(string nombre, string cargo, int numero_cuenta):cuentaEmpleado(nombre, 0, numero_cuenta)
{
    ...
    numero_empleados++;
    //cuentaEmpleado = CuentaBancaria(nombre_completo, 0, numero_cuenta);
...
void Empleado::vincularCliente(Cliente * cliente)
{
    cliente_asociado = cliente;
    cout<<"Agregó al cliente: "<<endl;
    cliente->mostrar_informacion();
}

void Empleado::desvincularCliente()
{
    cliente_asociado = nullptr; //puntero nulo
}
